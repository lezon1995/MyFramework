...
namespace MoreMountains.Tools
{
    ...
    public class MMSoundManagerEditor : Editor
    {
        ...
        protected virtual void DrawTrack(string title, bool mute, MMSoundManager.MMSoundManagerTracks track, Color muteColor, Color unmuteColor, Color pauseColor, Color stopColor, Color playColor, Color freeColor)
        {
            ...
            switch (track)
            {
                case MMSoundManager.MMSoundManagerTracks.Master:
                    ...
                    {
                        _mmSoundManager.settingsSo.SetTrackVolume(MMSoundManager.MMSoundManagerTracks.Master, newVolume);
                    }
        ...
        public virtual void DrawColoredButton(string buttonLabel, Color buttonColor, MMSoundManager.MMSoundManagerTracks track, Action<MMSoundManager.MMSoundManagerTracks> action, GUIStyle styles)
        {
