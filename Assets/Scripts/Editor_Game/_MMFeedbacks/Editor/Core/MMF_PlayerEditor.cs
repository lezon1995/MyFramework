...
namespace MoreMountains.Feedbacks
{
    ...
    {
        MMF_Player _player => (MMF_Player)target;
        ...
        protected GUIContent _feedbackEditGUIContent;
        ...
        protected const string _editText = "Edit";
        ...
        protected virtual void InspectorCaching()
        {
            ...
            _feedbackEditGUIContent = new GUIContent(_editText);
        ...
        protected virtual void DrawFeedbackHeader(int i)
        {
            ...
            {
                if (((MMF_Looper)_feedbackListFeedback).InfiniteLoop)
                {
                    _feedbackListLabel += _infiniteLoopText;
                }
                else
                {
                    _feedbackListLabel = _feedbackListLabel + "[ " + ((MMF_Looper)_feedbackListFeedback).NumberOfLoopsLeft + " loops left ] ";
                }
            }
            ...
            Rect headerRect = MMF_PlayerStyling.DrawHeader(
                ...
                menu =>
                {
                    menu.AddItem(_feedbackEditGUIContent, false, () => EditFeedback(i));
                    if (Application.isPlaying)
        ...
        {
            return _player.AddFeedback(type);
        }
        ...
        protected virtual void ResetContextMenuFeedback(int id)
        {
            ...
            Type feedbackType = _player.FeedbacksList[id].GetType();
            MMF_Feedback newFeedback = _player.AddFeedback(feedbackType, false);
            _player.FeedbacksList[id] = newFeedback;
            serializedObject.ApplyModifiedProperties();
            ForceRepaint();
            PrefabUtility.RecordPrefabInstancePropertyModifications(TargetMmfPlayer);
        }
        ...
        protected virtual void EditFeedback(int id)
        {
            MMF_Feedback feedback = TargetMmfPlayer.FeedbacksList[id];

            var name = feedback.GetType().Name;
        ...
        {
            MMF_PlayerCopy.CopyAll(_player);
        }
