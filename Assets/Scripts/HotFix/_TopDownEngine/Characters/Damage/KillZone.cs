...
namespace MoreMountains
{
    ...
    {
        [Header("Targets")]
        [MMInformation("This component will make your object kill objects that collide with it. Here you can define what layers will be killed.")]
        [Tooltip("the layers containing the objects that will be damaged by this object")]
        public LayerMask TargetLayerMask = LayerManager.Player_Mask;
