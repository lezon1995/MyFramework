...
namespace UniStats
{
    ...
    public static partial class Mod
    {
        ...
        public static NumMod<T> Add<T>(IVar<T> v, string name = null) where T : struct
        {
        ...
        public static NumMod<T> Mul<T>(IVar<T> v, string name = null) where T : struct
        {
        ...
        public static NumMod<T> Set<T>(IVar<T> v, string name = null) where T : struct
        {
