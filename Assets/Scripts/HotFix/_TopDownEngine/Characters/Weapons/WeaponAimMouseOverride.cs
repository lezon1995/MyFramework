...
namespace MoreMountains
{
    ...
    /// </summary>
    [AddComponentMenu("TopDown Engine/Weapons/WeaponAimMouseOverride")]
    public class WeaponAimMouseOverride : MonoBehaviour
    {
        ...
        public virtual void GetInitialAimControl()
        {
            ...
            {
                Debug.LogWarning(gameObject + " : this component requires that you set its associated WeaponAim to a control mode other than Mouse.");
            }
        }
        ...
        protected virtual void CheckMouseInput()
        {
            ...
            _mouseInput = _weaponAim.TargetWeapon.Owner.Input.MousePosition;
        ...
        protected virtual void CheckAxisInput()
        {
            if (CheckPrimaryAxis)
            {
                _primaryAxisInput = _weaponAim.TargetWeapon.Owner.Input.PrimaryMovement;
            ...
            {
                _secondaryAxisInput = _weaponAim.TargetWeapon.Owner.Input.SecondaryMovement;
