...
namespace MoreMountains.TopDownEngine
{
    ...
    /// </summary>
    [AddComponentMenu("TopDown Engine/Weapons/WeaponIK")]
    public class WeaponIK : TopDownMonoBehaviour
    {
        ...
        /// <summary>
        /// Detaches the hand from handle, if the IK is not active, set the position and rotation of the hand and head back to the original position
        /// </summary>
