...
namespace MoreMountains
{
    ...
    /// </summary>
    [AddComponentMenu("TopDown Engine/Managers/GameManager")]
        ...
        IEvent<TopDownEnginePointEvent>
    {
        ...
        public List<PointsOfEntryStorage> PointsOfEntry = new();
        ...
        public virtual void DestroyPersistentCharacter()
        {
            ...
            // if (LevelManager.Instance.Players[0])
            // {
            //     if (LevelManager.Instance.Players[0].TryGetComponent<CharacterPersistence>(out _))
            //     {
        ...
        /// </summary>
        /// <param name="e">MMGameEvent event.</param>
        ...
        /// </summary>
        /// <param name="e">TopDownEngineEvent event.</param>
        ...
        /// </summary>
        /// <param name="e">TopDownEnginePointEvent event.</param>
        public virtual void onEvent(TopDownEnginePointEvent e)
        {
        ...
        protected virtual void OnEnable()
        {
            ...
            this.addListener<TopDownEnginePointEvent>();
        }
