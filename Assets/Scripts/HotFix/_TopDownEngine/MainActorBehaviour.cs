...
{
    public class MainActorBehaviour : MMMonoBehaviour
        , IResetable
        , IReusable
    {
        ...
        {
            mPositionModifyCallback.Remove(callback);
        }
        ...
        {
            mRotationModifyCallback.Remove(callback);
        }
        ...
        public void removeWorldScaleModifyCallback(Action callback)
        {
            mWorldScaleModifyCallback.Remove(callback);
        }
        ...
        {
            mScaleModifyCallback.Remove(callback);
        }
