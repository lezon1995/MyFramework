...
namespace MoreMountains
{
    ...
    public class FText : MainActorBehaviour
    {
        public int useTimes = -1;

        protected Image _icon;
        protected Image _metaIcon;
        protected TextMeshProUGUI _tmp;
        protected TextMeshProUGUI _tmpOutline;
        protected TextMeshProUGUI _tmpPlus;
        protected TextMeshProUGUI _tmpPlusOutline;
        protected TextTMP _text;
        ...
        protected virtual void SetupTextTMP()
        {
            _text = new(_tmp, _tmpOutline);
        }
