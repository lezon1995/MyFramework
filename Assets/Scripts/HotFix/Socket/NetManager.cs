...
public class NetManager : FrameSystem
{
    ...
    {
        mServerConnect.startConnect(success =>
        {
            // 连接服务器以后检测消息版本号
            if (success)
            {
    ...
    public int getPing()
    {
        return mServerConnect.getPing();
    }

    public bool isConnected()
    {
        return mServerConnect.isConnected();
    }

    public NetConnectTCPBit getConnect()
    {
        return mServerConnect;
    }
