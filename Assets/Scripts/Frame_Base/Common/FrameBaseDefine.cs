...
public class FrameBaseDefine
{
	...
	public const string P_ASSET_BUNDLE_BUILD_PATH = "AssetBundleBuild/";
	public const string P_ASSET_BUNDLE_ANDROID_BUILD_PATH = P_ASSET_BUNDLE_BUILD_PATH + ANDROID + "/";
	public const string P_ASSET_BUNDLE_WINDOWS_BUILD_PATH = P_ASSET_BUNDLE_BUILD_PATH + WINDOWS + "/";
	public const string P_ASSET_BUNDLE_IOS_BUILD_PATH = P_ASSET_BUNDLE_BUILD_PATH + IOS + "/";
	public const string P_ASSET_BUNDLE_MACOS_BUILD_PATH = P_ASSET_BUNDLE_BUILD_PATH + MACOS + "/";
	public const string P_ASSET_BUNDLE_WEBGL_BUILD_PATH = P_ASSET_BUNDLE_BUILD_PATH + WEBGL + "/";
#if UNITY_ANDROID
