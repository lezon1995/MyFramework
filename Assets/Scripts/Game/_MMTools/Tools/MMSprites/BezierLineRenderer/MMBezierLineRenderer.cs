        ...
        protected virtual void DrawCurve()
        {
            for (var i = 0; i < NumberOfCurves; i++)
            {
                for (var j = 1; j <= NumberOfSegments; j++)
                {
                    ...
                    int pointIndex = i * 3;
                    var p0 = AdjustmentHandles[pointIndex].position;
                    var p1 = AdjustmentHandles[pointIndex + 1].position;
                    var p2 = AdjustmentHandles[pointIndex + 2].position;
                    var p3 = AdjustmentHandles[pointIndex + 3].position;
                    _point = BezierPoint(t, p0, p1, p2, p3);
