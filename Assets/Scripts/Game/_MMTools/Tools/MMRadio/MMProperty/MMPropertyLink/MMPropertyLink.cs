namespace MoreMountains.Tools
{
    ...
    public abstract class MMPropertyLink
    {
        ...
        public virtual object GetPropertyValue(MMProperty property)
        {
            ...
            return property.MemberType switch
            {
                MMProperty.MemberTypes.Property => property.MemberPropertyInfo.GetValue(target),
                MMProperty.MemberTypes.Field => property.MemberFieldInfo.GetValue(target),
                _ => 0f
            };
        }
        ...
        protected virtual void SetPropertyValue(MMProperty property, object newValue)
        {
            ...
            {
                case MMProperty.MemberTypes.Property:
                    property.MemberPropertyInfo.SetValue(target, newValue);
                    break;
                case MMProperty.MemberTypes.Field:
