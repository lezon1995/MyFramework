...
namespace MoreMountains.Tools
{
    public static class DataConverter
    {
        ...
        static byte[] buffer4 = new byte[sizeof(float) * 4];

        public static string GetString(Color value)
        {
            Buffer.BlockCopy(BitConverter.GetBytes(value.r), 0, buffer4, 0 * sizeof(float), sizeof(float));
            Buffer.BlockCopy(BitConverter.GetBytes(value.g), 0, buffer4, 1 * sizeof(float), sizeof(float));
            Buffer.BlockCopy(BitConverter.GetBytes(value.b), 0, buffer4, 2 * sizeof(float), sizeof(float));
            Buffer.BlockCopy(BitConverter.GetBytes(value.a), 0, buffer4, 3 * sizeof(float), sizeof(float));
            return Convert.ToBase64String(buffer4);
        }

        static byte[] buffer2 = new byte[sizeof(float) * 2];

        public static string GetString(Vector2 value)
        {
            Buffer.BlockCopy(BitConverter.GetBytes(value.x), 0, buffer2, 0 * sizeof(float), sizeof(float));
            Buffer.BlockCopy(BitConverter.GetBytes(value.y), 0, buffer2, 1 * sizeof(float), sizeof(float));
            return Convert.ToBase64String(buffer2);
        }

        static byte[] buffer3 = new byte[sizeof(float) * 3];

        public static string GetString(Vector3 value)
        {
            Buffer.BlockCopy(BitConverter.GetBytes(value.x), 0, buffer3, 0 * sizeof(float), sizeof(float));
            Buffer.BlockCopy(BitConverter.GetBytes(value.y), 0, buffer3, 1 * sizeof(float), sizeof(float));
            Buffer.BlockCopy(BitConverter.GetBytes(value.z), 0, buffer3, 2 * sizeof(float), sizeof(float));
            return Convert.ToBase64String(buffer3);
        }

        public static string GetString(Vector4 value)
        {
            Buffer.BlockCopy(BitConverter.GetBytes(value.x), 0, buffer4, 0 * sizeof(float), sizeof(float));
            Buffer.BlockCopy(BitConverter.GetBytes(value.y), 0, buffer4, 1 * sizeof(float), sizeof(float));
            Buffer.BlockCopy(BitConverter.GetBytes(value.z), 0, buffer4, 2 * sizeof(float), sizeof(float));
            Buffer.BlockCopy(BitConverter.GetBytes(value.w), 0, buffer4, 3 * sizeof(float), sizeof(float));
            return Convert.ToBase64String(buffer4);
        }
        ...
        public static string GetString(Rect value)
        {
            Buffer.BlockCopy(BitConverter.GetBytes(value.x), 0, buffer4, 0 * sizeof(float), sizeof(float));
            Buffer.BlockCopy(BitConverter.GetBytes(value.y), 0, buffer4, 1 * sizeof(float), sizeof(float));
            Buffer.BlockCopy(BitConverter.GetBytes(value.width), 0, buffer4, 2 * sizeof(float), sizeof(float));
            Buffer.BlockCopy(BitConverter.GetBytes(value.height), 0, buffer4, 3 * sizeof(float), sizeof(float));
            return Convert.ToBase64String(buffer4);
        }
