...
namespace MoreMountains.Tools
{
    ...
    public static class MMSaveLoadManager
    {
        ...
        static string DetermineSaveFileName(string fileName) => fileName;

        /// <summary>
        /// Save the specified saveObject, fileName and folder name into a file on disk.
        /// </summary>
        ...
        public static T Load<T>(string fileName, string folderName = _defaultFolderName)
        {
            return (T)Load(typeof(T), fileName, folderName);
        }
