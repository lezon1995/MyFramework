...
namespace MoreMountains.Tools
{
    ...
    public class MMSaveLoadTester : MonoBehaviour
    {
        ...
        /// Test button
        [MMInspectorButton(nameof(Save))]
        public bool TestSaveButton;

        /// Test button
        [MMInspectorButton(nameof(Load))]
        public bool TestLoadButton;

        /// Test button
        [MMInspectorButton(nameof(Reset))]
        ...
        {
            InitializeSaveLoadMethod();
            var testObject = MMSaveLoadManager.Load<MMSaveLoadTestObject>(FileName + SaveFileExtension, FolderName);
