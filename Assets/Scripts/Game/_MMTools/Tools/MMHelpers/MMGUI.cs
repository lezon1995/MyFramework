...
namespace MoreMountains.Tools
{
    public static class MMGUI
    {
        ...
        public static void SetSize(RectTransform rectTransform, Vector2 newSize)
        {
            ...
            rectTransform.offsetMin -= new Vector2(sizeDiff.x * rectTransform.pivot.x, sizeDiff.y * rectTransform.pivot.y);
            rectTransform.offsetMax += new Vector2(sizeDiff.x * (1.0f - rectTransform.pivot.x), sizeDiff.y * (1.0f - rectTransform.pivot.y));
        }
