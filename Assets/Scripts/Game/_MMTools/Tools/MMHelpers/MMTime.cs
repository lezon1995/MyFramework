...
namespace MoreMountains.Tools
{
    ...
    {
        /// <summary>
        /// Turns a float (expressed in seconds) into a string displaying hours, minutes, seconds and hundredths optionally
        /// </summary>
        /// <param name="t"></param>
        ...
        public static string FloatToTimeString(float t, bool displayHours = false, bool displayMinutes = true, bool displaySeconds = true, bool displayMilliseconds = false)
        {
            ...
            if (!displayHours && !displayMinutes && displaySeconds)
        ...
        public static float TimeStringToFloat(string timeInStringNotation)
        {
            ...
            string[] timeStringArray = timeInStringNotation.Split(new[] { ":", "." }, StringSplitOptions.None);
