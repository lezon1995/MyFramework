...
namespace MoreMountains.Tools
{
    ...
    public static class MMFade
    {
        ...
        public static IEnumerator<float> FadeImage(Image target, float duration, Color color)
        {
            if (target == null)
                yield break;
        ...
        /// <param name="opacity">Opacity.</param>
        /// <param name="duration">Duration.</param>
        public static IEnumerator<float> FadeText(Text target, float duration, Color color)
        {
            if (target == null)
                yield break;
        ...
        /// <param name="opacity">Opacity.</param>
        /// <param name="duration">Duration.</param>
        public static IEnumerator<float> FadeSprite(SpriteRenderer target, float duration, Color color)
        {
            if (target == null)
                yield break;
        ...
        public static IEnumerator<float> FadeCanvasGroup(CanvasGroup target, float duration, float targetAlpha, bool unscaled = true)
        {
            if (target == null)
                yield break;
