...
namespace MoreMountains.Tools
{
    ...
    public class MMAdditiveSceneLoadingManager : MMMonoBehaviour
    {
        ...
        [MMInspectorGroup("Audio Listener")]
        ...
        [MMInspectorGroup("Progress Events")]
        ...
        protected virtual void Initialization()
        {
            ...
            Timing.RunCoroutine(LoadSequence());
        }
        ...
        /// </summary>
        protected virtual IEnumerator<float> LoadSequence()
        {
            _antiSpill?.PrepareAntiFill(_sceneToLoadName, _antiSpillSceneName);
            InitiateLoad();
            yield return Timing.WaitUntilDone(ProcessDelayBeforeEntryFade());
            yield return Timing.WaitUntilDone(EntryFade());
            yield return Timing.WaitUntilDone(ProcessDelayAfterEntryFade());
            yield return Timing.WaitUntilDone(UnloadOriginScenes());
            yield return Timing.WaitUntilDone(LoadDestinationScene());
            yield return Timing.WaitUntilDone(ProcessDelayBeforeExitFade());
            yield return Timing.WaitUntilDone(DestinationSceneActivation());
            yield return Timing.WaitUntilDone(ExitFade());
            yield return Timing.WaitUntilDone(UnloadSceneLoader());
        }
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual IEnumerator<float> ProcessDelayBeforeEntryFade()
        {
            if (_beforeEntryFadeDelay > 0f)
            {
                ...
                yield return Timing.WaitUntilDone(MMCoroutine.WaitForUnscaled(_beforeEntryFadeDelay));
            }
        }
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual IEnumerator<float> EntryFade()
        {
            if (_entryFadeDuration > 0f)
            {
                ...
                yield return Timing.WaitUntilDone(MMCoroutine.WaitForUnscaled(_entryFadeDuration));
            }
        }
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual IEnumerator<float> ProcessDelayAfterEntryFade()
        {
            if (_afterEntryFadeDelay > 0f)
            {
                ...
                yield return Timing.WaitUntilDone(MMCoroutine.WaitForUnscaled(_afterEntryFadeDelay));
            }
        }
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual IEnumerator<float> UnloadOriginScenes()
        {
            foreach (Scene scene in _initialScenes)
            {
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual IEnumerator<float> LoadDestinationScene()
        {
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual IEnumerator<float> ProcessDelayBeforeExitFade()
        {
            if (_beforeExitFadeDelay > 0f)
            {
                ...
                yield return Timing.WaitUntilDone(MMCoroutine.WaitForUnscaled(_beforeExitFadeDelay));
            }
        }
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual IEnumerator<float> ExitFade()
        {
            SetAudioListener(false);
            if (_exitFadeDuration > 0f)
            {
                ...
                yield return Timing.WaitUntilDone(MMCoroutine.WaitForUnscaled(_exitFadeDuration));
            }
        }
        ...
        /// </summary>
        protected virtual IEnumerator<float> DestinationSceneActivation()
        {
            yield return Timing.WaitUntilDone(MMCoroutine.WaitForFrames(1));
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual IEnumerator<float> UnloadSceneLoader()
        {
            ...
            yield return Timing.WaitForOneFrame; // mandatory yield to avoid an unjustified warning
