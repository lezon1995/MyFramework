...
namespace MoreMountains.Tools
{
    ...
    public class MMSceneLoadingManager : MonoBehaviour
    {
        ...
        protected virtual void Start()
        {
            ...
            {
                Timing.RunCoroutine(LoadAsynchronously());
            }
        }
        ...
        /// </summary>
        protected virtual IEnumerator<float> LoadAsynchronously()
        {
            ...
            yield return Timing.WaitForSeconds(StartFadeDuration);
            ...
            LoadingComplete();
            yield return Timing.WaitForSeconds(LoadCompleteDelay);

            // we fade to black
            MMFadeInEvent.Trigger(ExitFadeDuration, _tween);
            yield return Timing.WaitForSeconds(ExitFadeDuration);
        ...
        protected virtual void LoadingComplete()
        {
            ...
            Timing.RunCoroutine(MMFade.FadeCanvasGroup(LoadingProgressBar, 0.1f, 0f));
            Timing.RunCoroutine(MMFade.FadeCanvasGroup(LoadingAnimation, 0.1f, 0f));
            Timing.RunCoroutine(MMFade.FadeCanvasGroup(LoadingCompleteAnimation, 0.1f, 1f));
        }
    }
}