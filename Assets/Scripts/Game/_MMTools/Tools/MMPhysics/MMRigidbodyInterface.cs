...
namespace MoreMountains.Tools
{
    ...
    public class MMRigidbodyInterface : MonoBehaviour
    {
        ...
        public Vector3 position
        {
            get
            {
                if (_rigidbody2D) return _rigidbody2D.position;
                if (_rigidbody) return _rigidbody.position;
                return Vector3.zero;
            }
            set { }
        }
        ...
        public Bounds ColliderBounds
        {
            get
            {
                if (_rigidbody2D) return _collider2D.bounds;
                if (_rigidbody) return _collider.bounds;
                return new Bounds();
            }
        }
