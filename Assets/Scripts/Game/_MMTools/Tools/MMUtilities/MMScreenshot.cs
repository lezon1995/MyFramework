...
namespace MoreMountains.Tools
{
    ...
    public class MMScreenshot : MonoBehaviour
    {
        ...
        protected virtual string TakeScreenCaptureScreenshot()
        {
            ...
            string savePath = FolderName + "/screenshot_" + width + "x" + height + "_" + DateTime.Now.ToString("yyyy-MM-dd_HH-mm-ss") + ".png";
        ...
        {
            string savePath = FolderName + "/screenshot_" + ResolutionWidth + "x" + ResolutionHeight + "_" + DateTime.Now.ToString("yyyy-MM-dd_HH-mm-ss") + ".png";
