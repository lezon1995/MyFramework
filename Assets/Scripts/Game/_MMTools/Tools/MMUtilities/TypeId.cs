...
namespace MoreMountains.Tools
{
    ...
    {
        public static readonly int Id = TypeId.StableId(typeof(T));
    }

    public static class TypeId<T1, T2>
    {
        public static readonly int Id = TypeId.StableId(typeof(T1), typeof(T2));
    }

    public static class TypeId
    {
        public static int StableId(Type type) => type.FullName.GetStableHashCode();
        public static int StableId(Type type1, Type type2) => (type1.FullName + type2.FullName).GetStableHashCode();
