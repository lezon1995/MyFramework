...
namespace MoreMountains.Tools
{
	...
	public class MMFader : MMMonoBehaviour, IEvent<MMFadeEvent>, IEvent<MMFadeInEvent>, IEvent<MMFadeOutEvent>, IEvent<MMFadeStopEvent>
	{
		...
		public virtual void onEvent(MMFadeEvent e)
		{
			...
			Fade(e.TargetAlpha, e.Duration, e.Curve, e.IgnoreTimeScale);
		}
