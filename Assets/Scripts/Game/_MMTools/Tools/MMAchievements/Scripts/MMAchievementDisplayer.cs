...
namespace MoreMountains.Tools
{
    ...
    public class MMAchievementDisplayer : MonoBehaviour, IEvent<MMAchievementUnlockedEvent>
    {
        [Header("Achievements")]
        ...
        public virtual IEnumerator<float> DisplayAchievement(MMAchievement achievement)
        {
            ...
            GameObject instance = Instantiate(AchievementDisplayPrefab.gameObject, transform, false);
            ...
            {
                canvasGroup.alpha = 0;
                Timing.RunCoroutine(MMFade.FadeCanvasGroup(canvasGroup, AchievementFadeDuration, 1));
                yield return Timing.WaitForSeconds(AchievementFadeDuration + AchievementDisplayDuration);
                Timing.RunCoroutine(MMFade.FadeCanvasGroup(canvasGroup, AchievementFadeDuration, 0));
            }
        }
        ...
        /// </summary>
        /// <param name="e">Achievement unlocked event.</param>
        public virtual void onEvent(MMAchievementUnlockedEvent e)
        {
            Timing.RunCoroutine(DisplayAchievement(e.Achievement));
        }
        ...
        {
            this.addListener<MMAchievementUnlockedEvent>();
        }
        ...
        {
            this.removeListener<MMAchievementUnlockedEvent>();
        }
    }
}