...
namespace MoreMountains.Tools
{
    ...
    public static class MMAchievementManager
    {
        ...
        {
            DeterminePath();
            var o = MMSaveLoadManager.Load<SerializedMMAchievementManager>(SaveFileName + _saveFileExtension, _saveFolderName);
            ExtractSerializedMMAchievementManager(o);
        }
        ...
        {
            DeterminePath();
            var o = new SerializedMMAchievementManager();
            FillSerializedMMAchievementManager(o);
            MMSaveLoadManager.Save(o, SaveFileName + _saveFileExtension, _saveFolderName);
        }
