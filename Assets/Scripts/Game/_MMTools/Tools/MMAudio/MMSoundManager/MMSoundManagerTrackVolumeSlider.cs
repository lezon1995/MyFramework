...
namespace MoreMountains.Tools
{
        ...
        IEvent<MMSoundManagerTrackFadeEvent>
    {
        ...
        /// </summary>
        /// <param name="e"></param>
        public void onEvent(MMSoundManagerEvent e)
        {
            if (e.EventType == MMSoundManagerEventTypes.SettingsLoaded)
            {
        ...
        /// </summary>
        /// <param name="e"></param>
        public void onEvent(MMSoundManagerTrackEvent e)
        {
        ...
        /// </summary>
        /// <param name="e"></param>
        public void onEvent(MMSoundManagerTrackFadeEvent e)
        {
            if (ChangeModeOnTrackFade)
            {
                ChangeModeToRead(e.FadeDuration + ModeSwitchBufferTime);
            }
        }
