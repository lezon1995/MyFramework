...
namespace MoreMountains.Tools
{
    public class MMSMPlaylistManager : MMMonoBehaviour
    {
        ...
        [MMInspectorGroup("Test Controls")]
        /// a play test button
        ...
        {
            PlaylistManagerState = new MMStateMachine<PlaylistManagerStates>(gameObject, true);
        ...
        {
            if (PlaylistManagerState.Is(PlaylistManagerStates.Idle))
            {
                this.enabled = false;
                return;
            }
        ...
        {
            if (PlaylistManagerState.Not(PlaylistManagerStates.Playing))
            {
                return;
            }
        ...
        protected virtual void OnApplicationPause(bool pauseStatus)
        {
            ...
            if (pauseStatus && PlaylistManagerState.Is(PlaylistManagerStates.Playing))
            {
                Pause();
