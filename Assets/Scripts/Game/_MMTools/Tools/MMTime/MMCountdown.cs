...
namespace MoreMountains.Tools
{
    ...
    public class MMCountdown : MMMonoBehaviour
    {
        ...
        [MMInspectorGroup("Countdown")]
        [MMInformation("You can define the bounds of the countdown (how much it should count down from, and to how much, the format it should be displayed in (standard Unity float ToString formatting).")]
        ...
        /// if this is true, the countdown will ping pong in the other direction when end is met 
        ...
        /// <summary>
        /// On Start, grabs and stores the Text component, and auto starts if needed
        /// </summary>
        ...
        /// <summary>
        /// Stops the countdown from count downing
        /// </summary>
