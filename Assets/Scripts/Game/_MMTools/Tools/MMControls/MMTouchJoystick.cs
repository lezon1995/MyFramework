...
namespace MoreMountains.Tools
{
    ...
    public class MMTouchJoystick : MMMonoBehaviour, IDragHandler, IEndDragHandler, IPointerDownHandler, IPointerUpHandler
    {
        ...
        [MMInspectorGroup("Joystick Behaviour")]
