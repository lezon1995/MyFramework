...
namespace MoreMountains.Tools
{
    ...
    /// </summary>
    public class MMControlsTestInputManager : MonoBehaviour, IEvent<MMSwipeEvent>
    {
        ...
        public virtual void onEvent(MMSwipeEvent e)
        {
            Debug.LogFormat("Swipe at a " + e.SwipeAngle + "° angle, and a length of " + e.SwipeLength + " length. Cardinal direction : " + e.SwipeDirection);
            Debug.LogFormat("Swipe origin : " + e.SwipeOrigin + ", swipe end : " + e.SwipeDestination);
            Debug.LogFormat("Swipe duration : " + e.SwipeDuration);
        }

        protected virtual void OnEnable()
        {
            this.addListener<MMSwipeEvent>();
        }

        protected virtual void OnDisable()
        {
            this.removeListener<MMSwipeEvent>();
        }
    }
}