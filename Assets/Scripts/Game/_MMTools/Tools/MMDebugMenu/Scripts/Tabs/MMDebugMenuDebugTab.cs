...
namespace MoreMountains.Tools
{
    ...
    {
        /// the scroll rect where the log will be displayed
        ...
        protected virtual void LateUpdate()
        {
            ...
            {
                Timing.RunCoroutine(ScrollToLogBottomCo());
            }
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual IEnumerator<float> ScrollToLogBottomCo()
        {
