...
namespace MoreMountains.Feedbacks
{
	...
	/// </summary>
	public abstract class MMSpringFloatComponent<T> : MMSpringComponentBase, IEvent<MMSpringFloatEvent> where T:Component
	{
		...
		public void onEvent(MMSpringFloatEvent e)
		{
			...
			{
				FloatSpring.Damping = e.NewDamping;
			}
			if (e.OverrideFrequency)
			{
				FloatSpring.Frequency = e.NewFrequency;
			}
			...
			switch (e.Command)
			{
				...
				case SpringCommands.MoveToRandom:
					MoveToRandom(e.MoveToRandomValue.x, e.MoveToRandomValue.y);
					break;
				...
				case SpringCommands.BumpRandom:
					BumpRandom(e.BumpAmountRandomValue.x, e.BumpAmountRandomValue.y);
					break;
		...
		protected override void Awake()
		{
			...
			base.Awake();
			this.addListener<MMSpringFloatEvent>();
		}

		protected void OnDestroy()
		{
			this.removeListener<MMSpringFloatEvent>();
		}
