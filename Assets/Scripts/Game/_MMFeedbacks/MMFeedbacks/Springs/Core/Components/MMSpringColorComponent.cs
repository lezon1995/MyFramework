...
namespace MoreMountains.Feedbacks
{
	...
	/// </summary>
	public abstract class MMSpringColorComponent<T> : MMSpringComponentBase, IEvent<MMSpringColorEvent> where T:Component
	{
		...
		public void onEvent(MMSpringColorEvent e)
		{
			...
			{
				ColorSpring.SetDamping(e.NewDamping);
			}
			if (e.OverrideFrequency)
			{
				ColorSpring.SetFrequency(e.NewFrequency);
			}
			switch (e.Command)
			{
		...
		protected override void Awake()
		{
			...
			base.Awake();
			this.addListener<MMSpringColorEvent>();
		}

		protected void OnDestroy()
		{
			this.removeListener<MMSpringColorEvent>();
		}
