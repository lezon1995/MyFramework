...
namespace MoreMountains.Feedbacks
{
	...
	/// </summary>
	public abstract class MMSpringVector3Component<T> : MMSpringComponentBase, IEvent<MMSpringVector3Event> where T:Component
	{
		...
		public void onEvent(MMSpringVector3Event e)
		{
			...
			{
				SpringVector3.SetDamping(e.NewDamping);
			}
			if (e.OverrideFrequency)
			{
				SpringVector3.SetFrequency(e.NewFrequency);
			}
			switch (e.Command)
			{
		...
		protected override void Awake()
		{
			...
			base.Awake();
			this.addListener<MMSpringVector3Event>();
		}

		protected void OnDestroy()
		{
			this.removeListener<MMSpringVector3Event>();
		}
