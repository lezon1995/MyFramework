...
namespace MoreMountains.Feedbacks
{
	...
	/// </summary>
	public abstract class MMSpringVector4<T> : MMSpringComponentBase, IEvent<MMSpringVector4Event> where T:Component
	{
		...
		public void onEvent(MMSpringVector4Event e)
		{
			...
			{
				SpringVector4.SetDamping(e.NewDamping);
			}
			if (e.OverrideFrequency)
			{
				SpringVector4.SetFrequency(e.NewFrequency);
			}
			switch (e.Command)
			{
		...
		protected override void Awake()
		{
			...
			base.Awake();
			this.addListener<MMSpringVector4Event>();
		}

		protected void OnDestroy()
		{
			this.removeListener<MMSpringVector4Event>();
		}
