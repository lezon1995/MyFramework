...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMFloatingText : MonoBehaviour
    {
        ...
        protected virtual void HandleAlignment()
        {
            ...
            {
                case MMFloatingTextSpawner.AlignmentModes.Fixed:
                    MovingPart.transform.up = _fixedAlignment;
                    break;
                case MMFloatingTextSpawner.AlignmentModes.MatchInitialDirection:
                    MovingPart.transform.up = transform.up;
                    break;
                case MMFloatingTextSpawner.AlignmentModes.MatchMovementDirection:
