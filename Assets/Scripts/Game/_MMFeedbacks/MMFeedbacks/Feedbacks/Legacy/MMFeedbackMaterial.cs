...
namespace MoreMountains.Feedbacks
{
	...
	public class MMFeedbackMaterial : MMFeedback
	{
		...
		public virtual float GetTime() { return (Time.TimescaleMode == TimescaleModes.Scaled) ? UnityEngine.Time.time : UnityEngine.Time.unscaledTime; }
		public virtual float GetDeltaTime() { return (Time.TimescaleMode == TimescaleModes.Scaled) ? UnityEngine.Time.deltaTime : UnityEngine.Time.unscaledDeltaTime; }
