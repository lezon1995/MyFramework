...
namespace MoreMountains.Feedbacks
{
	...
	public class MMFeedbackSpriteRenderer : MMFeedback
	{
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			switch (Mode)
			{
				...
				case Modes.OverTime:
					...
					_coroutine = Timing.RunCoroutine(SpriteRendererSequence());
					break;
				...
				case Modes.ToDestinationColor:
					...
					_coroutine = Timing.RunCoroutine(SpriteRendererToDestinationSequence(false));
					break;
				case Modes.ToDestinationColorAndBack:
					...
					_coroutine = Timing.RunCoroutine(SpriteRendererToDestinationSequence(true));
					break;
			}
		}
		...
		/// </summary>
		/// <returns></returns>
		protected virtual IEnumerator<float> SpriteRendererSequence()
		{
		...
		/// </summary>
		/// <returns></returns>
		protected virtual IEnumerator<float> SpriteRendererToDestinationSequence(bool andBack)
		{
			float journey = NormalPlayDirection ? 0f : FeedbackDuration;
			IsPlaying = true;
			Flip();
