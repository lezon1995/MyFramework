...
namespace MoreMountains.Feedbacks
{
	...
	public class MMFeedbackScale : MMFeedback
	{
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			if (isActiveAndEnabled || _hostMMFeedbacks.AutoPlayOnEnable)
			{
				if ((Mode == Modes.Absolute) || (Mode == Modes.Additive))
				{
					...
					_coroutine = Timing.RunCoroutine(AnimateScale(AnimateScaleTarget, Vector3.zero, FeedbackDuration, AnimateScaleX, AnimateScaleY, AnimateScaleZ, RemapCurveZero * intensityMultiplier, RemapCurveOne * intensityMultiplier));
				}
				if (Mode == Modes.ToDestination)
				{
					...
					_coroutine = Timing.RunCoroutine(ScaleToDestination());
				}                   
			}
		}
		...
		/// </summary>
		/// <returns></returns>
		protected virtual IEnumerator<float> ScaleToDestination()
		{
		...
		/// <returns></returns>
		protected virtual IEnumerator<float> AnimateScale(Transform targetTransform, Vector3 vector, float duration, AnimationCurve curveX, AnimationCurve curveY, AnimationCurve curveZ, float remapCurveZero = 0f, float remapCurveOne = 1f)
		{
