...
namespace MoreMountains.Feedbacks
{
	...
	public class MMFeedbackCameraZoom : MMFeedback
	{
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			MMCameraZoomEvent.Trigger(ZoomMode, ZoomFieldOfView, ZoomTransitionDuration, FeedbackDuration, ChannelData(Channel), Time.TimescaleMode == TimescaleModes.Unscaled, false, RelativeFieldOfView);
		}
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			MMCameraZoomEvent.Trigger(ZoomMode, ZoomFieldOfView, ZoomTransitionDuration, FeedbackDuration, ChannelData(Channel), Time.TimescaleMode == TimescaleModes.Unscaled, stop:true);
		}
	}
}