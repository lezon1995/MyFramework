...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_CameraOrthographicSize : MMF_Feedback
	{
		...
		public override void AutomaticShakerSetup()
		{
			...
			#if MMCINEMACHINE 
				CinemachineVirtualCamera virtualCamera = (CinemachineVirtualCamera)Object.FindFirstObjectByType(typeof(CinemachineVirtualCamera));
				virtualCameraFound = (virtualCamera != null);
			#elif MMCINEMACHINE3
				CinemachineCamera virtualCamera = (CinemachineCamera)Object.FindFirstObjectByType(typeof(CinemachineCamera));
				virtualCameraFound = (virtualCamera != null);
			#endif
			...
			MMCameraOrthographicSizeShaker orthographicSizeShaker = (MMCameraOrthographicSizeShaker)Object.FindFirstObjectByType(typeof(MMCameraOrthographicSizeShaker));
