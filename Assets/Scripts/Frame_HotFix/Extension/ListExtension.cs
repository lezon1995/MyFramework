...
public static class ListExtension
{
    ...
    public static int count<T>(this ICollection<T> list)
    {
        return list?.Count ?? 0;
    }

    public static bool isEmptySpan<T>(this Span<T> list)
    {
    ...
    public static IEnumerable<T> safe<T>(this IEnumerable<T> original)
    {
        return original ?? Empty<T>();
    }
}