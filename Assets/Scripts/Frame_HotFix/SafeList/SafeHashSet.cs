...
public class SafeHashSet<T> : ClassObject
{
    ...
    public HashSet<T> startForeach(string fileName = null)
    {
        ...
        else
        {
            ...
            {
                foreach (var value in modifies)
                {
                    if (value.isAdd)
                    {
                        mUpdateList.Add(value.value);
                    }
                    else
                    {
                        mUpdateList.Remove(value.value);
                    }
                }
            }
