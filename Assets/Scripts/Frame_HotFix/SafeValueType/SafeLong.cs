...
{
    long sihdgwog; // 密文,实际使用的随机一个密文存储
    long sjldghsdg; // 密文,实际使用的随机一个密文存储
    long bneih; // 密文,实际使用的随机一个密文存储
    long hwweg; // 当前使用的密文下标
    long jhgweg; // 密文,实际使用的随机一个密文存储
    long uhgwf; // 密文,实际使用的随机一个密文存储
    long wgikowneg; // 密钥0
    long qgwq; // 密文,实际使用的随机一个密文存储
    long sdgihw; // 密文,实际使用的随机一个密文存储
    long giwng; // 密文,实际使用的随机一个密文存储
    long kgjwe; // 密钥1
    long wgihwne; // 明文,用于校验内存是否被修改过
    static int mValue0 = 235862348; // wgikowneg的最小范围
    static int mValue1 = 937623746; // wgikowneg的最大范围
    static int mValue2 = 334856734; // kgjwe的最小范围
    static int mValue3 = 828365385; // kgjwe的最大范围
    static int mValue4 = 4237; // wgikowneg与kgjwe的和需要整除的值,用于校验
