...
{
    protected GameLayout layout; // 挂接的布局
    ...
    public void Update()
    {
        ...
        Name = layout.getName();
        ScriptControlHide = layout.isScriptControlHide();
        CheckBoxAnchor = layout.isCheckBoxAnchor();
        IgnoreTimeScale = layout.isIgnoreTimeScale();
        BlurBack = layout.isBlurBack();
        AnchorApplied = layout.isAnchorApplied();
        RenderOrder = layout.getRenderOrder();
        DefaultLayer = layout.getDefaultLayer();
    }
}