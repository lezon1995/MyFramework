...
public class ComponentKeyFrame : GameComponent, IComponentBreakable
{
    ...
    public void setKeyframeID(int keyframe)
    {
        mKeyframeID = keyframe;
    }

    public void setUpdateInFixedTick(bool inFixedTick)
    {
        mUpdateInFixedTick = inFixedTick;
    }
