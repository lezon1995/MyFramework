...
public class GoogleLogin : FrameSystem
{
    ...
    public void setReceiveGoogleTokenCallback(String2Callback callback)
    {
        mOnReceiveGoogleToken = callback;
    }
    ...
    public void setAndroidClassPath(string path)
    {
        mAndroidClassPath = path;
    }

    public void onLogin(string gooleToken)
    {
        mOnReceiveGoogleToken?.Invoke(gooleToken, null);
    }

    public void onLoginError(string errorCode)
    {
        mOnReceiveGoogleToken?.Invoke(null, errorCode);
    }
