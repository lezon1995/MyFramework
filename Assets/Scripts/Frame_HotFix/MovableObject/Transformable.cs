...
public class Transformable : ComponentOwner
{
    ...
    {
        return mObject != null && mObject.activeSelf;
    }

    public virtual bool isActiveInHierarchy()
    {
        return mObject != null && mObject.activeInHierarchy;
    }
    ...
    {
        mPositionModifyCallback += callback;
    }
    ...
    {
        mRotationModifyCallback += callback;
    }
    ...
    {
        return mTransform != null ? mTransform.GetSiblingIndex() : 0;
    }

    public int getChildCount()
    {
        return mTransform != null ? mTransform.childCount : 0;
    }

    public GameObject getChild(int index)
    {
        return mTransform != null ? mTransform.GetChild(index).gameObject : null;
    }

    public Vector3 getScale()
    {
        return mTransform != null ? mTransform.localScale : Vector3.zero;
    }

    public Vector3 getWorldPosition()
    {
        return mTransform != null ? mTransform.position : Vector3.zero;
    }

    public Vector3 getWorldScale()
    {
        return mTransform != null ? mTransform.lossyScale : Vector3.zero;
    }

    public Vector3 getWorldRotation()
    {
        return mTransform != null ? mTransform.rotation.eulerAngles : Vector3.zero;
    }
    ...
    {
        return mTransform != null ? mTransform.localRotation : Quaternion.identity;
    }

    public Quaternion getWorldQuaternionRotation()
    {
        return mTransform != null ? mTransform.rotation : Quaternion.identity;
    }
    ...
    {
        return mNeedUpdate && mObject.activeInHierarchy;
    }
}