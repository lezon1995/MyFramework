...
public class AtlasManager : FrameSystem
{
    ...
    public void addDontUnloadAtlas(string fileName)
    {
        mAssetBundleAtlasManager.addDontUnloadAtlas(fileName);
    }

    public SafeDictionary<string, AtlasBase> getAtlasList()
    {
        return mAssetBundleAtlasManager.getAtlasList();
    }

    public SafeDictionary<string, AtlasBase> getAtlasListInResources()
    {
        return mResourcesAtlasManager.getAtlasList();
    }
