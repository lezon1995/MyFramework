...
public class UGUIAtlasPtr : ClassObject
{
    ...
    public bool isValid()
    {
        return mAtlas != null && mAtlas.isValid();
    }
    ...
    {
        return mAtlas != null && mAtlas.hasSprite(sprite);
    }

    public string getFirstSpriteName()
    {
        return mAtlas?.getFirstSpriteName();
    }

    public Dictionary<string, Sprite> getSpriteList()
    {
        return mAtlas?.getSpriteList();
    }

    public string getFilePath()
    {
        return mAtlas?.getFilePath();
    }

    public AtlasBase getAtlas()
    {
        return mAtlas;
    }
