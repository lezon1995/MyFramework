...
public class LocalizationManager : FrameSystem
{
    ...
    public void setReloadLanguageCallback(OnReloadLanguage callback)
    {
        mReloadLanguageCallback = callback;
    }
    ...
    // 注册语言切换时的回调
    public void registeAction(Action langchange)
    {
        mLanguageCallback += langchange;
    }

    // 注销语言切换时的回调
    public void unregisteAction(Action langchange)
    {
        mLanguageCallback -= langchange;
    }
    ...
    {
        return mLocaleMap.get(mCurrentLanguage);
    }
