...
public abstract class UGUITreeNode : WindowRecyclableUGUI
{
    ...
    protected UGUITreeNode(IWindowObjectOwner parent) : base(parent)
    {
    }
    ...
    {
        base.init();
        root.registerCollider(onNodeClick);
    }

    public void setTree(UGUITreeList tree)
    {
        mTree = tree;
    }

    public void addChild(UGUITreeNode node)
    {
    ...
    public virtual void setExpand(bool expand)
    {
        mExpand = expand;
    }

    public UGUITreeList getTree()
    {
        return mTree;
    }
    ...
    public List<UGUITreeNode> getChildNodeList()
    {
        return mChildNodeList;
    }

    public UGUITreeNode getParentNode()
    {
        return mParentNode;
    }
