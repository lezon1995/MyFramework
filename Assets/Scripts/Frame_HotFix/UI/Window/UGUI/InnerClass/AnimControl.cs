...
public class AnimControl : ClassObject
{
    ...
    public void setObject(myUGUIObject obj)
    {
        mControlObject = obj;
    }
    ...
    {
        return intervalToSpeed(mInterval);
    }
    ...
    public bool isAutoResetIndex()
    {
        return mAutoResetIndex;
    }
    ...
    {
        return mTextureCount * mInterval;
    }

    // 获得实际的终止下标,如果是自动获得,则返回最后一张的下标
    public int getRealEndIndex()
    {
        return mEndIndex >= 0 ? mEndIndex : getMax(getTextureFrameCount() - 1, 0);
    }
    ...
    {
        setInterval(speedToInterval(speed));
    }
    ...
    public void setAutoHide(bool autoReset)
    {
        mAutoResetIndex = autoReset;
    }
