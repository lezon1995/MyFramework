...
public class GameLayout
{
    ...
    {
        return mGameObjectSearchList.get(go.GetInstanceID());
    }
    ...
    {
        return mRoot != null && mRoot.isActiveInHierarchy();
    }

    public bool isCheckBoxAnchor()
    {
        return mCheckBoxAnchor;
    }
    ...
    {
        return mNeedUpdateList.contains(uiObj);
    }

    public bool isScriptControlHide()
    {
        return mScriptControlHide;
    }
    ...
    {
        mScriptControlHide = control;
    }

    public void setCheckBoxAnchor(bool check)
    {
        mCheckBoxAnchor = check;
    }
    ...
    public void setInResources(bool inResources)
    {
        mInResources = inResources;
    }
    ...
    public void setBlurBack(bool blurBack)
    {
        mBlurBack = blurBack;
    }

    public void setParent(myUGUIObject parent)
    {
        mParent = parent;
    }
    ...
    protected void setUIDepth(myUGUIObject window, int orderInParent, bool includeSelf = true, bool ignoreInactive = false)
    {
        ...
        if (includeSelf && (transform.childCount > 0 || mGlobalTouchSystem.isColliderRegistered(window) || canvas != null))
        {
