...
public class Waiting : ClassObject
{
    ...
    public void setCancelCondition(BoolFunction func)
    {
        mCancelCondition = func;
    }

    public void setCondition(BoolFunction func)
    {
        mCondition = func;
    }

    public void setDoneFunction(Action func)
    {
        mDoneFunction = func;
    }
    ...
    {
        return mCancelCondition?.Invoke() ?? false;
    }
