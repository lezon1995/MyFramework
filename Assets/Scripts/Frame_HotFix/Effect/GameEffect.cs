...
public class GameEffect : MovableObject
{
    ...
    public void setExistObject(bool exist)
    {
        mExistedObject = exist;
    }
    ...
    {
        mMoveToHide = moveToHide;
    }

    public void setEffectDestroyCallback(GameEffectCallback effect)
    {
