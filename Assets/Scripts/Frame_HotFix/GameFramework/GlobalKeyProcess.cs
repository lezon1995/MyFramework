...
public partial class GlobalKeyProcess : FrameSystem
{
    public override void update(float dt)
    {
        if (isEditor() || isWindows())
        {
            ...
            {
                GameEntry.getInstance().frameworkParam.enableScriptDebug = !GameEntry.getInstance().frameworkParam.enableScriptDebug;
            ...
            {
                GameEntry.getInstance().frameworkParam.enablePoolStackTrace = !GameEntry.getInstance().frameworkParam.enablePoolStackTrace;
