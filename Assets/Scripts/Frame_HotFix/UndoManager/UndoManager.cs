...
public class UndoManager : FrameSystem
{
    ...
    public void setMaxUndoCount(int count)
    {
        mMaxUndo = count;
    }
    ...
    public void addUndoRedoChangeCallback(Action callback)
    {
        mUndoRedoChangeCallback += callback;
    }

    public void removeUndoRedoChangeCallback(Action callback)
    {
        mUndoRedoChangeCallback -= callback;
    }
