...
public class Command : ClassObject
{
    ...
    public virtual void debugInfo(MyStringBuilder builder)
    {
        builder.append(GetType().ToString());
    }

    public LOG_LEVEL getCmdLogLevel()
    {
        return mCmdLogLevel;
    }

    public bool isDelayCommand()
    {
        return mDelayCommand;
    }
    ...
    public bool isThreadCommand()
    {
        return mThreadCommand;
    }

    public void setCmdLogLevel(LOG_LEVEL level)
    {
        mCmdLogLevel = level;
    }

    public void setDelayCommand(bool delay)
    {
        mDelayCommand = delay;
    }
    ...
    public void setResultListen(BOOL result)
    {
        mResult = result;
    }

    public void setThreadCommand(bool threadCmd)
    {
        mThreadCommand = threadCmd;
    }
