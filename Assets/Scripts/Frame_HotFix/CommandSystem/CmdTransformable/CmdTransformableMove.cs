...
public class CmdTransformableMove : Command
{
    ...
    public override void execute()
    {
        ...
        if (isEditor() && obj is myUGUIObject uiObj && !isFloatZero(mOnceLength) && !uiObj.getLayout().canUIObjectUpdate(uiObj))
        {
    ...
    {
        builder.append(": mKeyframe:", mKeyframe).append(", mOnceLength:", mOnceLength).append(", mOffset:", mOffset).append(", mStartPos:", mStartPos).append(", mTargetPos:", mTargetPos).append(", mLoop:", mLoop);
    }
}