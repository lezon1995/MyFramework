...
public class CmdMovableObjectVolume : Command
{
    ...
    {
        builder.append(": mKeyframe:", mKeyframe).append(", mOnceLength:", mOnceLength).append(", mOffset:", mOffset).append(", mStartVolume:", mStartVolume).append(", mTargetVolume:", mTargetVolume).append(", mLoop:", mLoop);
    }
}