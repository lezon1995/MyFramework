...
public class CharacterState : ClassObject
{
    ...
    public virtual void setParam(StateParam param)
    {
        mParam = param;
    }
    ...
    public void setStateMaxTime(float stateTime)
    {
        mStateMaxTime = stateTime;
    }
    ...
    public void setJustEnter(bool just)
    {
        mJustEnter = just;
    }
    ...
    public BUFF_STATE_TYPE getBuffStateType()
    {
        return mBuffStateType;
    }
    ...
    public STATE_MUTEX getMutexType()
    {
        return mMutexType;
    }
