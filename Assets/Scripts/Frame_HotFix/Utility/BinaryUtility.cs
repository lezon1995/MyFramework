...
public class BinaryUtility
{
    ...
    public static short bytesToShortBigEndian(byte byte0, byte byte1)
    {
    ...
    {
        return (ushort)((b1 << (8 * 1)) | (b0 << (8 * 0)));
    }

    public static ushort bytesToUShortBigEndian(byte b0, byte b1)
    {
        return (ushort)((b1 << (8 * 0)) | (b0 << (8 * 1)));
    }
    ...
    public static int bytesToIntBigEndian(byte b0, byte b1, byte b2, byte b3)
    {
        return (b3 << (8 * 0)) | (b2 << (8 * 1)) | (b1 << (8 * 2)) | (b0 << (8 * 3));
    }
    ...
    public static bool hasBit(byte value, byte pos)
    {
        return (value & (1 << pos)) != 0;
    }

    public static bool hasBit(sbyte value, byte pos)
    {
        return (value & (1 << pos)) != 0;
    }

    public static bool hasBit(short value, byte pos)
    {
        return (value & (1 << pos)) != 0;
    }

    public static bool hasBit(ushort value, byte pos)
    {
        return (value & (1 << pos)) != 0;
    }

    public static bool hasBit(int value, byte pos)
    {
        return (value & (1 << pos)) != 0;
    }

    public static bool hasBit(uint value, byte pos)
    {
        return (value & (1 << pos)) != 0;
    }

    public static bool hasBit(long value, byte pos)
    {
        return (value & ((long)1 << pos)) != 0;
    }

    public static bool hasBit(ulong value, byte pos)
    {
    ...
    public static void setBitOne(ref byte value, byte pos)
    {
        value |= (byte)(1 << pos);
    }

    public static void setBitOne(ref sbyte value, byte pos)
    {
        value |= (sbyte)(1 << pos);
    }

    public static void setBitOne(ref short value, byte pos)
    {
        value |= (short)(1 << pos);
    }

    public static void setBitOne(ref ushort value, byte pos)
    {
        value |= (ushort)(1 << pos);
    }

    public static void setBitOne(ref int value, byte pos)
    {
        value |= 1 << pos;
    }

    public static void setBitOne(ref uint value, byte pos)
    {
        value |= (uint)(1 << pos);
    }

    public static void setBitOne(ref long value, byte pos)
    {
        value |= (long)1 << pos;
    }

    public static void setBitOne(ref ulong value, byte pos)
    {
        value |= (ulong)1 << pos;
    }

    public static void setBitZero(ref byte value, byte pos)
    {
        value &= (byte)~(1 << pos);
    }

    public static void setBitZero(ref sbyte value, byte pos)
    {
        value &= (sbyte)~(1 << pos);
    }

    public static void setBitZero(ref short value, byte pos)
    {
        value &= (short)~(1 << pos);
    }

    public static void setBitZero(ref ushort value, byte pos)
    {
        value &= (ushort)~(1 << pos);
    }

    public static void setBitZero(ref int value, byte pos)
    {
        value &= ~(1 << pos);
    }

    public static void setBitZero(ref uint value, byte pos)
    {
        value &= (uint)~(1 << pos);
    }

    public static void setBitZero(ref long value, byte pos)
    {
        value &= ~((long)1 << pos);
    }

    public static void setBitZero(ref ulong value, byte pos)
    {
        value &= ~((ulong)1 << pos);
    }
    ...
    {
        return (bitCount & 7) != 0 ? (bitCount >> 3) + 1 : bitCount >> 3;
    }

    public static bool getBufferBit(byte[] buffer, int bitIndex)
    {
        return hasBit(buffer[bitIndex >> 3], (byte)(bitIndex & 7));
    }

    public static void setBufferBitOne(byte[] buffer, int bitIndex)
    {
        setBitOne(ref buffer[bitIndex >> 3], (byte)(bitIndex & 7));
    }
