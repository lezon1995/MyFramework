...
public class EditorDefine
{
    ...
    //-----------------------------------------------------------------------------------------------------------------------------
    protected virtual List<string> getLayoutScriptBaseClass_Extension()
    {
        return new();
    }

    protected virtual List<string> getNoMipmapsPath_Extension()
    {
        return new();
    }

    protected virtual List<string> getKeepFolder_Extension()
    {
        return new();
    }

    protected virtual List<string> getUnpackFolder_Extension()
    {
        return new();
    }

    protected virtual List<string> getForceSingleFolder_Extension()
    {
        return new();
    }

    protected virtual List<string> getIgnoreScriptCheck_Extension()
    {
        return new();
    }

    protected virtual List<string> getIgnoreComment_Extension()
    {
        return new();
    }

    protected virtual List<string> getIgnoreConstructValue_Extension()
    {
        return new();
    }

    protected virtual List<Type> getIgnoreResetPropertyClass_Extension()
    {
        return new();
    }

    protected virtual List<string> getIgnoreLayoutScript_Extension()
    {
        return new();
    }
    ...
    protected virtual List<string> getIgnoreVariableCheck_Extension()
    {
        return new();
    }

    protected virtual List<string> getIgnoreCheckClass_Extension()
    {
        return new();
    }
    ...
    protected virtual List<string> getIgnoreCheckFunction_Extension()
    {
        return new();
    }

    protected virtual List<string> getIgnoreSystemFunctionCheck_Extension()
    {
        return new();
    }
}